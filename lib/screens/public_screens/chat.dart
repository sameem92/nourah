...
class _ChatState extends State<Chat> {
  void messageStream() async {
    await for (var snapshot in _fireStore
        .collection('chats/${widget.orderNo}/messages')
        .snapshots()) {
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        for (var message in messages) {
                          ...
                          // final fcmToken = message.get('fcmToken');
...
class _NewMessageWidgetState extends State<NewMessageWidget> {
  ...
  void sendMessage() async {
    ...
    _fireStore.collection('chats/${widget.orderNo}/messages').add({
    ...
    await AppController().sendChatController(
        receiverId: senderr == "driver" ? widget.userId : widget.driverId,
        orderNo: widget.orderNo);
    _controller.clear();
  }
}
